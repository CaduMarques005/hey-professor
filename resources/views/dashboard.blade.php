    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <div class="dark:text-gray-400 space-y-4">
                ...
                <form class="max-w-md mx-auto" action="{{ route('dashboard') }}" method="get">
